...
const Home = () => {
  ...
  const platforms = [
    ...
    { name: 'Google Analytics', logo: '/images/platforms/google-analytics.svg' },
    { name: 'Search Console', logo: '/images/platforms/google-search-console.png' },
    { name: 'SemRush', logo: '/images/platforms/semrush.png' },
